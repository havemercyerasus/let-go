if (status == 'loading') {
	if (!document.getElementById('letgothewall')) {
	...
	// need to check for youtube video and pause
	var youTube = document.getElementById("movie_player");
	...
	var intervalId = setInterval(function() {
			...
			if (letgocount < 0) {
				...
				// need to check for youtube video and play
				if (typeof(youTube) != 'undefined' && youTube != null)
				{
				  youTube.playVideo();
				}
